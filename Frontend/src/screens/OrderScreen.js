...
const addPaypalSdk = async (totalPrice) => {
   ...
   if (!window.paypal) {
      ...
      script.src = "https://www.paypal.com/sdk/js?&client-id=<var>Client-ID</var>&merchant-id=<var>Merchant-ID</var>";
      script.async = true;
      ...
      <h1>Order ${_id}</h1>
         <div class="order"> 
            <div class="order-info">
               ...
               <div>
                  <h2>Payment</h2>
                  <div class="shipping">Payment Method : ${payment.paymentMethod}</div>
